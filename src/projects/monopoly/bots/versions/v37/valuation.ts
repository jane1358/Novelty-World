// ===========================================================================
// v37 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md).
// v37 boosts RAILROAD valuation. The b2studios 11.2M-game self-play AI found
// railroads (especially early ones) to be key strategic assets. The v29 bot
// gives ZERO synergy value to a single railroad. v37 adds base value to the
// first railroad and steepens the synergy curve. Distress pricing verbatim. — fork of the champion v28 (see EVOLUTION.md). IDENTICAL to v28
...
// v37: First railroad now has value — steady $25 income + stepping stone
//  + denial. Progression steepens to reflect the jump from 2→3 rails ($100 rent).
const RAIL_SYNERGY: readonly number[] = [0, 40, 120, 250, 480];
