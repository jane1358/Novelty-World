...
// ===========================================================================
// v8 SNAPSHOT — carries v5's trade-to-deny engine VERBATIM (see EVOLUTION.md). v8's
// own change is the COUPLING with v4 tempo in `./valuation.ts`; this trade module
// is unchanged from v5, reproduced here so the snapshot is self-contained. v5's
