// ===========================================================================
// v28 SNAPSHOT — fork of the champion v17 (see EVOLUTION.md). Carries v17's lowered
// liquidity reserve (`FLOOR_RENT_FRACTION` 0.3, `FLOOR_CAP` 300) verbatim. v28's
// ADDITION lives in the DISTRESS section below `liquidityFloor`: a model of when a
// seat is genuinely near-bankrupt (`isDistressed`) and the discount a distressed
// SELLER applies to the rival-monopoly threat premium it holds out for
// (`distressThreatScale`) — the seller half of the coupled desperation-acquisition
// hypothesis (lead b). `trades.ts` applies the scale in `rivalThreatCost`. Everything
// else is v17 verbatim. Shared infrastructure is imported from the canonical modules.
// ===========================================================================
 ...
 *  premium it forgoes is the buyer's discount. Tuned below 1.0 so even a
 *  desperate seat keeps SOME guard against arming the rival who is squeezing it. */
const DISTRESS_DISCOUNT = 0.75;
