...
// v10 carries v5's trade-to-deny engine VERBATIM (the v10 change is in the auction
// channel — see auction.test.ts). These tests pin that the carried trade
// construction is intact in v10, importing `./trades` (v10's copy).
//
