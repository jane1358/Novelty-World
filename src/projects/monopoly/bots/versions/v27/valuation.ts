// ===========================================================================
// v27 SNAPSHOT — fork of the champion v17 (see EVOLUTION.md). Lead (c), magnitude 2.
// v26 leapt dark-blue all the way to the published #2 (weight 0.73, bonus 548) and
// leaned slightly NEGATIVE (−10.9 Elo) — over-valuing a LOW-traffic 2-lot set in the
// own-buy/liquidation channels swamped any competitive-channel gain. v27 tries a
// SMALLER, more conservative correction: lift dark-blue only to ≈#4, level with the
// other big sets (green 460 / yellow 480), rather than leaping past them. Weight
// 0.55→0.62 → monopolyBonus 413→465 (just above green 460, below yellow 480). The
// published "desirability per roll" cluster is tight (dark-blue 3.10 ≈ red 3.09 ≈
// yellow 3.03), so nudging dark-blue out of LAST-of-the-big-sets (v17's #5) without
// over-valuing its rarity is the more defensible read of the discrepancy. Everything
// else (liquidity reserve, trades.ts, dispatcher) is v17 verbatim.
// ===========================================================================
 ...
 *
 *  v27 RAISES dark-blue 0.55→0.62 (lead c, magnitude 2 — a SMALLER bump than v26's
 *  0.73). v26 leapt to the published #2 (bonus 548) and leaned −11 Elo; v27 lifts
 *  dark-blue only to ≈#4 — level with the other big sets — to nudge it out of
 *  last-of-the-big-sets (v17's #5, 413) without over-valuing a low-traffic 2-lot set.
 *  0.62 lifts its bonus 413→465 (just above green 460, below yellow 480). The other
 *  seven weights are v17 verbatim. Resulting bonuses ≈ orange 560 > red 544 > yellow
 *  480 > dark-blue 465 > green 460 > pink 374 > light-blue 320 > brown 84.
