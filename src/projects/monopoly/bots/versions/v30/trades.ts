...
// ===========================================================================
// v30 SNAPSHOT — VERBATIM v28's trades.ts (v30's only change is the distress GATE
// `DISTRESS_MARGIN` in valuation.ts; v29 changed `DISTRESS_DISCOUNT` there too).
// The mechanism below is v28's:
