...
// v35 changes claude.ts only (auction logic); trade engine is v34 verbatim. — fork of the champion v29 (see EVOLUTION.md).
// v34 changes valuation.ts only; trade engine is v29 verbatim. — VERBATIM v28's trades.ts (v29's only change is the
