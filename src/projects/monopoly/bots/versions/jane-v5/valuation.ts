// ===========================================================================
// jane-v5 SNAPSHOT — fork of jane-v2 (see EVOLUTION.md).
// jane-v5 reorders the SPREAD DEVELOPMENT phase by 3-house rent-per-dollar
// ROI instead of the classic traffic tier list. — fork of jane-v1 (see EVOLUTION.md).
...
/** Development priority for the SPREAD PHASE, ordered by 3-house ROI.
 *  Higher ROI sets get developed first so each dollar generates max rent. */
const SPREAD_ORDER: readonly PropertyColor[] = [
  "yellow",
  "pink",
  "orange",
  "red",
...
export function planBuild(state: GameState, pid: string): BuildPlan | null {
  ...
  for (const color of SPREAD_ORDER) {
