// ===========================================================================
// v7 SNAPSHOT — a self-contained copy of the bot's policy (see EVOLUTION.md).
// Branched from v5. v7's behavioral change lives entirely in `./trades.ts`
// (EARLY DENIAL: extend v5's trade-to-deny to also block a rival TWO lots short of
// a strong set, by taking one of the two missing lots from a third-party holdout —
// holding one needed lot makes the set impossible, caught while lots are still
// distributed and cheap); this valuation copy is VERBATIM from v5/v3, kept here so
// the version is whole and can be run/branched in isolation. Shared, non-strategic
