// ===========================================================================
// v5 SNAPSHOT — a self-contained copy of the bot's policy (see EVOLUTION.md).
// Branched from v3. v5's behavioral change lives entirely in `./trades.ts`
// (TRADE-TO-DENY: extend N-way construction to block a rival one lot short of a
// set by buying that completer lot from a third-party holdout, priced off the
// existing DENY_FACTOR lever); this valuation copy is VERBATIM from v3, kept here
// so the version is whole and can be run/branched in isolation. Shared,
