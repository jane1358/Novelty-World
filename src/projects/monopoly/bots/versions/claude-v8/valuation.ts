// ===========================================================================
// v8 SNAPSHOT — a self-contained copy of the bot's policy (see EVOLUTION.md).
// Branched from v5 (whose `./trades.ts` carries v5's TRADE-TO-DENY + v3 N-way +
// v2 rival-threat pricing, kept verbatim). v8 COUPLES denial with tempo: this
