...
**Promotion status (product call — `bots/live.ts`):** **`LIVE_VERSION = v35`** (promoted
2026-06-21 — the win-safe strong-set hot-potato fix: EVEN vs champion v29, no regressions,
and it kills the value-less denial rotation a live game exposed). Champion stays **v29** by
Elo (v35 is EVEN, not better). v35 carries the whole v29 mechanism + v14's phantom-denial fix.
